...
$Periods = $Grades = $Headers = $Titles = $Games = $What = "";
$Periods = $data->Period;
$Grades = $data->Grade;
...
$pickPeriod = "MathKids.Period IN (".$Periods.")";
...
function makeWhat() { #builds WHERE clause
    global $Periods, $Games, $Grades, $Dates, $pickGrade, $pickPeriod, $pickGame, $pickDates, $pickSort;
    $what = "";
    if ($Grades !== "") {
        if ($what === "") {
            $what = " ".$pickGrade;
