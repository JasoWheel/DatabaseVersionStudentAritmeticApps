...
<div id="gameBox">
  ...
  <div id="topRow">
    ...
    <div class="topStuff" id="title">(#6"A") Add and Subtract (Sum Practice)<br>Integers(2 Numbers)
...
var smile = 0, frown = 0, gameNameber = "6A"; //use these along with answered to update score function //New for Db************
var fixedTime = 25000;
