...
<head>
  ...
  <title> #9 Easy Random Questions </title>
</head>
...
<div id="gameBox">
  ...
  <div id="topRow">
    ...
    <div class="topStuff" id="title" >
      (#9) Add, Subtract, Multiply and Divide Practice<br>Easy Integers
...
var smile = 0, frown = 0, gameNameber = "9"; //use these along with answered to update score function //New for Db************
var fixedTime = "";
...
function askQuestion() {
  ...
  if (many == 2) {
    fixedTime = 20000;
    document.getElementById("SecToEnd").innerHTML = "-->25";
  } else if (many == 3) {
    fixedTime = 25000;
      document.getElementById("SecToEnd").innerHTML = "-->30";
  } else {
    fixedTime = 75000;
