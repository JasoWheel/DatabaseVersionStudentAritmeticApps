...
<div id=\"namesOne\"><p><b>1st Pd Names</b></p>
 ...
 while ($row = $data1->fetch()) {
    echo "<label for=".$row['UserName']."><input type=\"radio\" id=".$row['RealName']." name=\"CheckName\" value=".$row['UserName']." onchange=\"displayUser()\" />".$row['RealName']."/".$row['UserName']."/".$row['Grade']."</label><br>";
};
echo "</div></div>
